...
IMPORTANT: This plugin uses `net.java.dev.javacc:javacc:5.0`. It is possible to overwrite the project dependency configuration 'javacc', if you want to use another library for JavaCC code generation.
